      ...
      <>
        ...
        <div className="container">
          ...
          <div id="currentlyReadingList" className=" row">
            ...
            {
              this.props.Allbooks.filter(b => b.shelf === "currentlyreading").length > 0 ?
                this.props.Allbooks.filter(b => b.shelf === "currentlyreading").map((book, index) => {
                  return (
                    <BookCard key={index} book={book} index={index} changeState={this.changeState} />
                  )
                })
          ...
          <div id="wantReadList" className="  row">
            ...
            {
              this.props.Allbooks.filter(b => b.shelf === "wanttoread").length > 0 ?
                this.props.Allbooks.filter(b => b.shelf === "wanttoread").map((book, index) => {
                  return (
                    <BookCard key={index} book={book} index={index} changeState={this.changeState} />
                  )
                })
          ...
          <div id="ReadList" className=" row">
            {/* {
              this.props.read.length > 0 ?
                ...
                {
              this.props.Allbooks.filter(b => b.shelf === "read").length > 0 ?
                this.props.Allbooks.filter(b => b.shelf === "read").map((book, index) => {
                  return (
                    <BookCard key={index} book={book} index={index} changeState={this.changeState} />
                  )
                })
